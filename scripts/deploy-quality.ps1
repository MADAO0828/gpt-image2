...
function Invoke-PreviewStaticChecks([string]$Url) {
  ...
  if (-not ($root.Content -match 'home-v3-20260708-prompt-detail-hydrate-r78')) {
    throw "Preview HTML does not contain expected asset version home-v3-20260708-prompt-detail-hydrate-r78."
  }
