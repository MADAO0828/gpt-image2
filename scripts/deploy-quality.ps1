...
function Invoke-PreviewStaticChecks([string]$Url) {
  ...
  if (-not ($root.Content -match 'home-v3-20260709-agent-scroll-anchor-r82')) {
    throw "Preview HTML does not contain expected asset version home-v3-20260709-agent-scroll-anchor-r82."
  }
