...
function Invoke-StaticDeployChecks([string]$Url, [string]$Label) {
  ...
  if (-not ($root.Content -match 'home-v3-20260711-viewer-layout-r91')) {
    throw "$Label HTML does not contain expected asset version home-v3-20260711-viewer-layout-r91."
  }
