...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260705-full-audit-r25', 'Index must load cache-busted homepage v3 CSS r25.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260705-full-audit-r25', 'Index must load cache-busted homepage v3 JS r25.');
