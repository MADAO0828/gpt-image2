...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260708-full-qa-r72', 'Index must load cache-busted homepage v3 CSS r72.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260708-full-qa-r72', 'Index must load cache-busted homepage v3 JS r72.');
