...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260717-image-proxy-parity-r103', 'Index must load cache-busted homepage v3 CSS r103.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260717-image-proxy-parity-r103', 'Index must load the cache-busted stream runtime r103.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260717-image-proxy-parity-r103', 'Index must load cache-busted homepage v3 JS r103.');
