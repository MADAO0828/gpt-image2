...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260711-context-menu-r93', 'Index must load cache-busted homepage v3 CSS r93.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260711-context-menu-r93', 'Index must load the cache-busted stream runtime r93.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260711-context-menu-r93', 'Index must load cache-busted homepage v3 JS r93.');
