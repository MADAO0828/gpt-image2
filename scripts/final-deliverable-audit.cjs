...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260720-stability-r192', 'Index must load cache-busted homepage v3 CSS r192.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260720-stability-r192', 'Index must load cache-busted stream runtime r192.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260720-stability-r192', 'Index must load cache-busted homepage v3 JS r192.');
