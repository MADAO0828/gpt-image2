...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260725-mask-lifecycle-r200', 'Index must load cache-busted homepage v3 CSS r200.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260725-mask-lifecycle-r200', 'Index must load cache-busted stream runtime r200.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260725-mask-lifecycle-r200', 'Index must load cache-busted homepage v3 JS r200.');
