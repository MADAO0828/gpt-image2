...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260717-image-proxy-parity-r101', 'Index must load cache-busted homepage v3 CSS r101.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260717-image-proxy-parity-r101', 'Index must load the cache-busted stream runtime r101.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260717-image-proxy-parity-r101', 'Index must load cache-busted homepage v3 JS r101.');
