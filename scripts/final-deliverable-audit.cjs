...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260709-prompt-register-local-r79', 'Index must load cache-busted homepage v3 CSS r79.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260709-prompt-register-local-r79', 'Index must load cache-busted homepage v3 JS r79.');
