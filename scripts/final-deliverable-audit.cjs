...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260709-agent-scroll-anchor-r82', 'Index must load cache-busted homepage v3 CSS r82.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260709-agent-scroll-anchor-r82', 'Index must load cache-busted homepage v3 JS r82.');
