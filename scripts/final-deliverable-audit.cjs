...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260712-gallery-card-fit-r97', 'Index must load cache-busted homepage v3 CSS r97.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260712-gallery-card-fit-r97', 'Index must load the cache-busted stream runtime r97.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260712-gallery-card-fit-r97', 'Index must load cache-busted homepage v3 JS r97.');
