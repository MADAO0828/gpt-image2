...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260711-viewer-layout-r91', 'Index must load cache-busted homepage v3 CSS r91.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260711-viewer-layout-r91', 'Index must load the cache-busted stream runtime r91.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260711-viewer-layout-r91', 'Index must load cache-busted homepage v3 JS r91.');
