...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260708-agent-head-r74', 'Index must load cache-busted homepage v3 CSS r74.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260708-agent-head-r74', 'Index must load cache-busted homepage v3 JS r74.');
