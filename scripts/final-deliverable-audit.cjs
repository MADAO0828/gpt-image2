...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260711-image-copy-r92', 'Index must load cache-busted homepage v3 CSS r92.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260711-image-copy-r92', 'Index must load the cache-busted stream runtime r92.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260711-image-copy-r92', 'Index must load cache-busted homepage v3 JS r92.');
