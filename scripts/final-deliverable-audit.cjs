...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260708-prompt-detail-hydrate-r78', 'Index must load cache-busted homepage v3 CSS r78.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260708-prompt-detail-hydrate-r78', 'Index must load cache-busted homepage v3 JS r78.');
