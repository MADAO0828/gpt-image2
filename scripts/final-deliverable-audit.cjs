...
assertContains(index, '/assets/homepage-v3.css?v=home-v3-20260714-image-stream-stack-safe-r99', 'Index must load cache-busted homepage v3 CSS r99.');
assertContains(index, '/assets/image-stream-runtime.js?v=home-v3-20260714-image-stream-stack-safe-r99', 'Index must load the cache-busted stream runtime r99.');
assertContains(index, '/assets/homepage-v3.js?v=home-v3-20260714-image-stream-stack-safe-r99', 'Index must load cache-busted homepage v3 JS r99.');
